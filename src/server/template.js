/* eslint-disable no-var,prefer-template,vars-on-top,func-names,prefer-arrow-callback */
...
module.exports = function (templateParams) {
  ...
  if (options.isomorphicState) {
    js += '<script>var __INITIAL_STATE__ = <%- ' + options.isomorphicState + ' %></script>';
  }

  js += htmlWebpackPlugin.files.js.map(function (chunk) {
